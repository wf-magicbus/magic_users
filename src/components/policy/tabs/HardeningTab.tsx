      ...
      {!role ? null : loading ? (
        ...
        >
          ...
          <div className="pb-4 mb-4" style={{ borderBottom: "1px solid var(--border)" }}>
            <h3 className="policy-section-title">Local Administrator</h3>
          ...
          <div className="pb-4 mb-4 border-b" style={{ borderBottom: "1px solid var(--border)" }}>
            <h3 className="policy-section-title">LAPS (Local Admin Password Solution)</h3>
            <PolicyToggle
              label="LAPS Enabled"
          ...
          {/* UAC */}
          <div className="pb-4 mb-4 border-b" style={{ borderBottom: "1px solid var(--border)" }}>
            <h3 className="policy-section-title">User Account Control (UAC)</h3>
            <PolicyToggle
              label="UAC Enabled"
          ...
          {/* PowerShell */}
          <div className="pb-4 mb-4 border-b" style={{ borderBottom: "1px solid var(--border)" }}>
            <h3 className="policy-section-title">PowerShell Logging</h3>
            <PolicyToggle
          ...
          {/* BitLocker */}
          <div>
            <h3 className="policy-section-title">BitLocker</h3>
            <PolicyToggle
