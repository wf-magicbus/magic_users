  ...
  return (
    <div className="protected-card">
      <div className="protected-card-header">
        <div>
          <h3 className="protected-card-title">Logon Restrictions — Super Admin</h3>
      ...
      <div className="protected-card-content">
        ...
        <p className="protected-card-text">Unrestricted access</p>
        <p className="protected-card-description">Super admins can log on anywhere — local, RDP, service — without restriction</p>
      </div>
    </div>
  );
}
