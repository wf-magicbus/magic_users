  ...
  return (
    <div className="protected-card">
      <div className="protected-card-header">
        <div>
          <h3 className="protected-card-title">Password Policy — Super Admin</h3>
      ...
      <div className="protected-card-content">
        ...
        <p className="protected-card-text">Strictest policy enforced</p>
        <p className="protected-card-description">Super admin password policy is locked to the highest security standard and cannot be changed</p>
      </div>
    </div>
  );
}
        ...
        >
          ...
          {!editing && policy?.updated_at && (
            <div className="flex justify-between py-2.5">
              <span className="text-sm small-text">Last Updated</span>
