  ...
  return (
    <div className="rounded-2xl overflow-hidden" style={{ background: "var(--surface)", boxShadow: "var(--shadow-md)" }}>
      <div className="px-6 py-4 flex items-center justify-between" style={{ borderBottom: "1px solid var(--border)" }}>
        <div>
          <h3 className="text-sm font-semibold" style={{ color: "var(--text-1)" }}>Account Lockout — Super Admin</h3>
      ...
      <div className="px-6 py-8 text-center">
        ...
        <p className="text-sm font-semibold mb-1" style={{ color: "var(--text-1)" }}>Never locked out</p>
        <p className="text-xs" style={{ color: "var(--text-3)" }}>Super admins bypass all lockout restrictions by design</p>
      </div>
    </div>
  );
}
