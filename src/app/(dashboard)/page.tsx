  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#fffefb] to-[#fff8e8]">
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="mb-8">
          <p className="text-sm font-medium mb-1 text-yellow-600">Welcome back</p>
          <h1 className="text-3xl font-bold tracking-tight text-gray-900">System Overview</h1>
          <p className="text-sm mt-1 text-gray-600">MagicBus Admin Console — real-time security dashboard</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden">
          <div className="px-6 py-4 flex items-center justify-between border-b border-gray-200">
            ...
            <a href="/users" className="text-xs font-semibold text-yellow-700 transition-colors hover:text-white">View all →</a>
          </div>
          <table className="w-full">
            <thead className="bg-yellow-50 border-b border-gray-200">
              <tr>
                {["User", "Status", "Role", "Last Login"].map(h => (
                  <th key={h} className="px-6 py-3 text-left text-[11px] font-bold uppercase tracking-wider text-gray-700">{h}</th>
                ))}
              </tr>
            </thead>
            <tbody>
